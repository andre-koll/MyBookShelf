...
export default function LoadingSpinner() {
  return (
    <>
    <span className="inline-flex cursor-not-allowed items-center rounded-md px-4 py-2 text-sm leading-6 font-semibold text-white transition duration-150 ease-in-out">
