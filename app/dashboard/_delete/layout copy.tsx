  ...
  return (
    <>
      <main className="flex w-full flex-col max-w-7xl mx-auto px-4 sm:px-8">
        <header className="bg-white sticky top-0 flex h-16 items-center justify-between gap-4 border-b">
          <Sheet>
            ...
            <nav className="flex gap-4">
                <Link href="/dashboard" className="flex gap-2 select-none font-extrabold">
                    <Image width={20} height={20} src="/images/logo.svg" alt="MyBookShelf logo" />
                    <p>MyBookShelf</p>
                </Link>
