...
export default function Dashboard({
  ...
  params: { user: string; asset: string; shelf: string };
}) {
    // console.log(params.user);
    // console.log(params.asset);
    // console.log(params.shelf);
    return (
        <>
        <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-3 mt-10">
            <Card>
                ...
                <CardContent>
                    <p className="text-2xl font-bold">
                        <Suspense fallback={<>...</>}>
                            <Counter userId={params.user} action="totalassets" />
                        </Suspense>
                    </p>
            ...
            <Card>
                ...
                <CardContent>
                    <p className="text-2xl font-bold">
                        <Suspense fallback={<>...</>}>
                            <Counter userId={params.user} action="totalshelfs" />
                        </Suspense>
                    </p>
            ...
            <Card>
                ...
                <CardContent>
                    <p className="text-2xl font-bold">
                        <Suspense fallback={<>...</>}>
                            <Counter userId={params.user} action="totalusers" />
                        </Suspense>
                    </p>
